  ...
  <div class="wrap">
      ...
      <div class="circle-border">
        ...
        <Row class-name="input-Row" >
          ...
          <Col class-name="Col" span="19"><Input v-model="telnetName" size="small" placeholder="请输入..." ></Input></Col>
        </Row>
        <Row class-name="input-Row" >
          <Col class-name="Col Col-label" span="5">客户端：</Col>
  ...
  export default {
    ...
    methods: {
      generateDat () {
        ...
        if (!vueState.originalFilePath || !this.telnetName || !this.telnetCode || !this.device || !this.version || !this.lastVersion || !this.description) {
          ...
          this.$store.dispatch({
            ...
            jsonObj: {
              ...
              Device: this.device,
              TelnetName: this.telnetName,
              TelnetCode: this.telnetCode,
